    ...
    <div className="relative mt-3 w-full px-4 text-center">
      <div className="flex items-center justify-center gap-6">
        ...
        <div className="relative flex h-[5rem] flex-col items-center justify-center gap-3">
          ...
          <span className="inset-0 flex translate-x-[2.2rem] translate-y-[-1.1rem] rotate-[-25deg] items-center justify-center overflow-visible text-3xl font-semibold whitespace-nowrap text-black not-even:absolute md:translate-x-[11.25rem] md:translate-y-[-1.2rem] md:text-5xl">
            The Official
          </span>

          <div className="h-[3px] w-[18.75vw] bg-black md:h-[4px] md:w-[25vw]"></div>
          <div className="h-[3px] w-[18.75vw] bg-black md:h-[4px] md:w-[25vw]"></div>
          <div className="h-[3px] w-[18.75vw] bg-black md:h-[4px] md:w-[25vw]"></div>
        </div>
